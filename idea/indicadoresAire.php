...
?>
<h4 class="alert_info">Generación de Indicadores de Aire</h4><br>
<center>
    <br><br><br>
    <p>Los datos utilizados para realizar el cálculo de los indicadores, <br>son datos que se encuentran en <br>condición estandar.</p>
    <br><br><br>
                    ...
                    <select clase="aire" name="idVariable" id="idVariable" onchange="obtenerEstacion();">
                        ...
                        if (getEstacionVar() != null) {
                            foreach (getEstacionVar() as $value) {
                                echo "<option value='".$value["id"]."'>ICA ".strtoupper(str_replace("_",",",str_replace("PM","PM ",$value["nombre"])))."</option>";
                            }
                        }else{
