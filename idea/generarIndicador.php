<?php   
    ...
    if ($_POST) {
		...
		if ($temp == 1) {
			...
			$pos = $pos+1;
			$sql = ", tmax, tmin, tmed";
			$cabeza = "<td>Temp <br>Máxima (ºC)</td><td>Temp <br>Mínima (ºC)</td><td>Temp<br>Promedio (ºC)</td><td>Gráfica</td>";
		...
		if ($dvv == 5) {
			...
			$archivoPlano = $separador."VV Max (m/s)".$separador."Escala Beaufort".$separador
							."Descripción Beaufort".$separador."VV Media (m/s)".$separador."Escala Beaufort"
							.$separador."Descripción Beaufort";
		...
		if ($pbm == 8) {
			...
			$cabeza = "<td>Máximo PB<br>(hPa)</td><td>Mínimo PB<br>(hPa)</td><td>Media PB<br>(hPa)</td><td>Gráfica</td>";
			...
			$archivoPlano = $separador."Máximo PB (hPa)".$separador."Mínimo PB (hPa)".$separador."Media PB (hPa)";
			arregloTablasIndicadores($sql, $cabeza, $archivoPlano);
			if ($menor!=$mayor) {
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td>Promedio Máximo PB<br>(hPa)</td><td>Promedio Mínimo PB<br>(hPa)</td>
				<td>Promedio Media PB<br>(hPa)</td><td>Gráfica</td>";
				$archivoRangAn.= $separador."Promedio Máximo PB (hPa)".$separador."Promedio Mínimo PB (hPa)".$separador."Promedio Media PB (hPa)";
				$incremento = 3;
				$posGraficaRangoAnios = array($posGraficaRangoAnios[0], $posGraficaRangoAnios[1], $posGraficaRangoAnios[2], 
		...
		if ($aridez == 11) {
			...
			$cabeza = "<td>Indice de<br>aridez Martonne</td><td>Zona de<br>aridez Martonne</td><td>Gráfica</td>";
