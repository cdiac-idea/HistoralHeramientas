...
page.includeCSS {
 ...
 file1.media = screen
 file2 = fileadmin/templates/css/unalhome.css
...
#<INCLUDE_TYPOSCRIPT: source="FILE: fileadmin/templates/menuService.ts">
<INCLUDE_TYPOSCRIPT: source="FILE: fileadmin/templates/banners.ts">
<INCLUDE_TYPOSCRIPT: source="FILE: fileadmin/templates/background.ts">
<INCLUDE_TYPOSCRIPT: source="FILE: fileadmin/templates/analytics.ts">
#<INCLUDE_TYPOSCRIPT: source="FILE: fileadmin/templates/sitemap.ts">
