<?php   
    ...
    if ($_GET) {
        ...
        $datDVVD = datRosaVientsDiurRangAnual($idEst, $ani, $ani2);
        $datDVVN = datRosaVientsNocRangAnual($idEst, $ani, $ani2);
        ...
        $datosEst = velVientoRangoAnual($idVariable, $idEst, $ani, $ani2);


        if ($datosEst) {
            foreach ( $datosEst as $value) {
                $data["id"][] = $value["mes"]."/".$value["año"];
...
?>
    ...
    <script type="text/javascript" src="../bd/js/amcharts.js"></script>
    <script type="text/javascript" src="../bd/js/radar.js"></script>
    <script type="text/javascript" src="../bd/js/highcharts.js"></script>
    <script type="text/javascript" src="../bd/js/highcharts-more.js"></script>
