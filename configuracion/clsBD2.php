...
class clsDatos {
	...
	***********************************************************************/
	public function __construct(){
		$servidor = "localhost";
		$puerto = "5432";
		//$baseDatos = "bodega_carga_consulta";
		#$baseDatos = "bodegaVariablesAmbientales";
		$baseDatos = "bodegaVariablesAmbientales_Anterior06-11-2015";
		$usuario = "postgres";
		$clave = "%froac$";
	...
	***********************************************************************/
	public function generarArreglo($dato){
		$arreglo = pg_fetch_array($dato);//, 0, PGSQL_BOTH );
		return $arreglo;
	}
