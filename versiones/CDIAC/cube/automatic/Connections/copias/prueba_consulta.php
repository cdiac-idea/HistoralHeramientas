<?php
$estacionElegida = 'est_marquetalia';// tabla en la cual se encuentral los datos
...
############################# senda parte del insert ##################
			...
			$consulta2 = "SELECT $arreglo_variables_db from $tabla where fecha > '$fecha' order by fecha, hora"; 
	...
	$crear_central = "CREATE TABLE central
		(
		  ...
		  temperatura_max character varying,
		  temperatura_min character varying,
		  temperatura_med character varying,
