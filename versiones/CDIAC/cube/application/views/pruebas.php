    ...
    <form name="form1" method="post" action="<?php echo base_url() ?>index.php/esquema/imp/" enctype="multipart/form-data" id="form1">
        ...
        <article class="module width_quarter">
            ...
            <div class="module_content">   
                ...
                Filtro: <input type="text" id="box1Filter" /><button type="button" id="box1Clear">X</button><br />
        ...
        <article class="module width_quarter">
            ...
            <div class="module_content">   
                Filtro: <input type="text" id="box3Filter" /><button type="button" id="box3Clear">X</button><br />
        ...
        <article class="module width_quarter">
            ...
            <div class="module_content">   
                Filtro: <input type="text" id="box5Filter" /><button type="button" id="box5Clear">X</button><br />
