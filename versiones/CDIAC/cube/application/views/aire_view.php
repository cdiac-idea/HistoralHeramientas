<script language="javascript" type="text/javascript">
 ...
 $(document).ready(function(){
        $("#red").change(function(){
           $("#estacion").load("<?php echo base_url(); ?>index.php/aire/estacion_select/"+$("#red").val())
        });
	});
	...
	<section id="main" class="column">
		...
		<h4 class="alert_info">Filtrar archivos de aire.</h4>
		
                <article class="module width_full">
<form name="cargar_archivo_frm" method="post" action="../filtros/traductorAire.php" enctype="multipart/form-data" id="testform">
    <br>
