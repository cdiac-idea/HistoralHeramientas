<?php
    ...
    if ($_POST) {
        ...
        if($variables[0]['precipitacion'] > 0 && $variables[0]['temperatura'] > 0 && $perfil<5) {
        ...
        if($perfil<5 && $variables[0]['temperatura'] > 0 && $variables[0]['humedad_relativa'] > 0 && $variables[0]['velocidad_viento'] > 0) {
