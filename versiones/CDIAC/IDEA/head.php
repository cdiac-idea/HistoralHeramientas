...
<body>
	...
	<main class="detalle">
	<div id="corp">
		<a  href="http://www.corpocaldas.gov.co/" target="_blank"><img src="images/logo_Corpocaldass.png" width=35%></a>
	</div>
	<br>
	<br>
	<br>
		...
		<div id="header">
			<ul class="nav">
				<li id="emparejar"><a href="index.php" class="btn btn-default" role="button">INICIO<br><br></a>
					...
					<ul>
						<li><a href="convenios.php" class="btn btn-default" role="button">CONVENIO</a></li>
						<li><a href="resena.php" class="btn btn-default" role="button">SOBRE CDIAC</a></li>
					</ul>
				</li>
				<li><a href="fuentes.php" class="btn btn-default" role="button">FUENTES <br>DE DATOS</a></li>
			<li><a href="estructura.php" class="btn btn-default" role="button">ESTRUCTURA <br>DE DATOS</a></li>
			<li  id="emparejar"><a href="resultados.php" class="btn btn-default" role="button">RESULTADOS<br><br></a></li>
			<li><a href="enlaces.php" class="btn btn-default" role="button">ENLACES DE <br>INTERÉS</a></li>
			<li  id="emparejar"><a href="publicaciones.php" class="btn btn-default" role="button">PUBLICACIONES<br><br></a></li>
			<li  id="emparejar"><a href="th.php" class="btn btn-default" role="button">PERSONAS<br><br></a></li>
			<!--li  id="emparejar"><a href="solicitud.php" class="btn btn-default" role="button">SOLICITUD INFORMACIÓN<br><br></a></li-->
			<li  id="emparejar"><a href="contacto.php" class="btn btn-default" role="button">CONTACTO<br><br></a></li>
			</ul>
		</div>
	<br><br><br>