...
<div>
	<blockquote>
		...
		Universidad Nacional de Colombia and Corpocaldas, 2015. [Online]. 
		Available: http://froac.manizales.unal.edu.co/cube/IDEA/index.php. [Accessed: <?php $hoy = getdate(); echo $hoy['mday']."-".$hoy['mon']."-".$hoy['year']; ?>].
	</blockquote>
</div>
	...
	<div class="row">
		...
		<div class="col-md-2 col-lg-2 col-sm-2 col-xs-12 logos">
			<a href="http://www.orgulloun.unal.edu.co"><img alt="Orgullo UN" src="IDEA/images/log_orgullo.png" width="78" height="21" title="Orgullo UN"/></a>
			<a href="http://www.agenciadenoticias.unal.edu.co/inicio.html" class="imgAgencia"><img alt="Agencia de Noticias" src="IDEA/images/log_agenc.png" width="78" height="21" title="Agencia de Noticias"/></a>
			<div class="clear">
			</div>
			<a href="http://www.gobiernoenlinea.gov.co/web/guest"><img alt="Programa gobierno en línea" src="IDEA/images/log_gobiern.png" width="67" height="51" title="Programa gobierno en línea"/></a>
			<a href="http://www.contaduria.gov.co/"><img alt="Contaduría general de la republica" src="IDEA/images/log_contra.png" width="67" height="51" title="Contaduría general de la republica"/></a>
		</div>
	</div>
	</footer>
	<script src="IDEA/js/unal.js" type="text/javascript"></script>
</body>
</html>