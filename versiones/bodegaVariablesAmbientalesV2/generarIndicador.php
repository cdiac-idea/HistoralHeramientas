<?php   
    ...
    if ($_POST) {
		...
		$cabeza = $títulos1."<td class='titulo'>Estacion</td>";
		//$arrayCabeza = array(0 => "<br><br><center><table border = 1 ><tr class = 'cabecera'>", 1 => "<td class='titulo'>Estacion</td>" );
		...
		if ($Anual == 1) {
			...
			$cabezaAnual = $cabeza."<td class='titulo'>Año</td>";
		...
		if ($menor!=$mayor) {
			...
			$cabezaRangoAn= $cabeza."<td class='titulo'>Rango de<br> Años</td>";
		...
		if ($mes == 2) {
			...
			$cabezaMes = $cabeza."<td class='titulo'>Año</td><td class='titulo'>Mes</td>";
		...
		if ($dia == 3) {
			...
			$cabezaDia .= $títulos.$cabeza."<td class='titulo'>Año</td><td class='titulo'>Mes</td><td class='titulo'>Día</td>";
		...
		if ($temp == 1) {
			...
			$pos = $pos+1;
			$sql = ", tmax, tmin, tmed";
			$cabeza = "<td  class='titulo'>Temp <br>Maxima (ºC)</td><td  class='titulo'>Temp <br>Minima (ºC)</td><td class='titulo'>Temp<br>Promedio (ºC)</td><td class='titulo'>Grafica</td>";
			$títulos .= "<td colspan='4' class='titulo'>Temperatura<br>TEMP</td>";
			$titRangoAño .= "<td colspan='4' class='titulo'>Temperatura<br>TEMP</td>";
			$titAño .= "<td colspan='4' class='titulo'>Temperatura<br>TEMP</td>";
			$titMes .= "<td colspan='4' class='titulo'>Temperatura<br>TEMP</td>";
			...
			if ($menor!=$mayor) {
				...
				$cabezaRangoAn.="<td class='titulo'>Promedio Temps<br>Maxima (ºC)</td><td class='titulo'>Promedio Temps<br>Minima (ºC)</td><td class='titulo'>Promedio Temps<br>Promedio (ºC)</td><td class='titulo'>Grafica</td>";
		...
		if ($rangoTemp == 2) {
			...
			$pos = $pos+1;
			$sql = ", trango";
			$cabeza = "<td class='titulo'>Rango<br>Temp (ºC)</td><td class='titulo'>Grafica</td>";
			$títulos .= "<td colspan='2' class='titulo'>Amplitud o rango <br>de temperatura<br>RANGO-TEMP</td>";
			$titRangoAño .= "<td colspan='2' class='titulo'>Amplitud o rango <br>de temperatura<br>RANGO-TEMP</td>";
			$titAño .= "<td colspan='2' class='titulo'>Amplitud o rango <br>de temperatura<br>RANGO-TEMP</td>";
			$titMes .= "<td colspan='2' class='titulo'>Amplitud o rango <br>de temperatura<br>RANGO-TEMP</td>";
			...
			if ($menor!=$mayor) { 
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td class='titulo'>Promedio Rango<br>Temp (ºC)</td><td class='titulo'>Grafica</td>";
		...
		if ($ppt == 3) {
			...
			$pos = $pos+1;
			$sql = ", ppt";
			$cabeza = "<td class='titulo'>Ppt acumulada<br>(mm)</td>";
			$títulos .= "<td colspan='3' class='titulo'>Precipitación<br>Ppt</td>";
			$titRangoAño .= "<td colspan='2' class='titulo'>Precipitación<br>Ppt</td>";
			$titAño .= "<td colspan='3' class='titulo'>Precipitación<br>Ppt</td>";
			$titMes .= "<td colspan='3' class='titulo'>Precipitación<br>Ppt</td>";
			...
			if ($menor!=$mayor) {
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td class='titulo'>Promedio Ppt acumulada<br> anual (mm)</td><td class='titulo'>Grafica</td>";
				$archivoRangAn.=$separador."Promedio Ppt acumulada anual (mm)";
				$incremento = 1;
			...
			$cabezaDia .= "<td class='titulo'>Intensidad de <br>LLuvia (mm/h)<br>-Primeros 5 minutos-</td><td class='titulo'>Grafica</td>";
			$archivoPlanoDia .= $separador."Intensidad de LLuvia -Primeros 5 minutos-(mm/h)";

			$sqlMes .= ", dias_sin_lluvia";
			$cabezaMes .= "<td class='titulo'>Dias sin<br> LLuvia</td><td class='titulo'>Grafica</td>";
			$archivoPlanoMes .= $separador."Dias sin LLuvia";
		
			$sqlAnual .= ", desc_lluvia";
			$cabezaAnual .= "<td class='titulo'>Descripción</td><td class='titulo'>Grafica</td>";
		...
		if ($pptA25 == 4) {
			...
			$pos = $pos+1;
			$sqlMes .= ", ac_25";
			$cabezaMes .= "<td class='titulo'>A25<br> Maximo</td><td class='titulo'>Grafica</td>";
			$titRangoAño .= "<td class='titulo'>Lluvia acumulada<br>Ppt.Ac-A25</td>";
			$archivoPlanoMes .= $separador."A25 Maximo Mes";
			$sqlAnual .= ", ac_25";
			$cabezaAnual .= "<td class='titulo'>A25<br> Maximo</td><td class='titulo'>Grafica</td>";
			$archivoPlanoAnual .= $separador."A25 Maximo Año";

			$sqlDia .= ", ac_25, nivel_alerta";
			$cabezaDia .= "<td class='titulo'>A25</td><td class='titulo'>Nivel<br>Alerta</td><td class='titulo'>Grafica</td>";
			$títulos .= "<td colspan='3' class='titulo'>Lluvia acumulada<br>Ppt.Ac-A25</td>";
			$titAño .= "<td colspan='2' class='titulo'>Lluvia acumulada<br>Ppt.Ac-A25</td>";
			$titMes .= "<td colspan='2' class='titulo'>Lluvia acumulada<br>Ppt.Ac-A25</td>";
			
			if ($menor!=$mayor) {
				$cabezaRangoAn.="<td class='titulo'>Grafica</td>";
			}
		...
		if ($dvv == 5) {
			...
			$cabeza = "<td class='titulo'>VV Max (m/s)</td><td class='titulo'>Escala<br>Beaufort</td><td class='titulo'>Descripción<br>Beaufort</td>
						<td class='titulo'>VV Media (m/s)</td><td class='titulo'>Escala<br>Beaufort</td><td class='titulo'>Descripción<br>Beaufort</td>
						<td class='titulo'>Grafica</td>";

			$títulos .= "<td colspan='7' class='titulo'>Dirección y velocidad del viento<br>DVV</td>";
			$titRangoAño .= "<td colspan='3' class='titulo'>Dirección y velocidad del viento<br>DVV</td>";
			$titAño .= "<td colspan='7' class='titulo'>Dirección y velocidad del viento<br>DVV</td>";
			$titMes .= "<td colspan='7' class='titulo'>Dirección y velocidad del viento<br>DVV</td>";
			...
			if ($menor!=$mayor) {
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td class='titulo'>Promedio VV Max (m/s)</td><td class='titulo'>Promedio VV Media (m/s)</td><td class='titulo'>Grafica</td>";
			...
			$cabezaDia .= "<td class='titulo'>VV Max<br>(m/s)</td>
							<td class='titulo'>VV Media<br>(m/s)</td>
							<td class='titulo'>Direccion<br>Diurno</td>
							<td class='titulo'>Frecuencia<br>Direccion<br>Diurno(%)</td>
							<td class='titulo'>Direccion<br>Nocturno</td>
							<td class='titulo'>Frecuencia<br>Direccion<br>Nocturno (%)</td>
							<td class='titulo'>Rosa de<br>los Vientos</td>";
		...
		if ($hrmHrmm == 6) {
			...
			$cabeza = "<td class='titulo'>HR<br> Max (%)</td><td class='titulo'>HR<br> Min (%)</td><td class='titulo'>HR<br> Med (%)</td><td class='titulo'>Grafica</td>";
			$títulos .= "<td colspan='4' class='titulo'>Humedad relativa<br>HRm-HRmm</td>";
			$titRangoAño .= "<td colspan='4' class='titulo'>Humedad relativa<br>HRm-HRmm</td>";
			$titAño .= "<td colspan='4' class='titulo'>Humedad relativa<br>HRm-HRmm</td>";
			$titMes .= "<td colspan='4' class='titulo'>Humedad relativa<br>HRm-HRmm</td>";
			...
			if ($menor!=$mayor) {
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td class='titulo'>Promedio HR<br> Max (%)</td><td class='titulo'>Promedio HR<br> Min (%)</td>
				<td class='titulo'>Promedio HR<br> Med (%)</td><td class='titulo'>Grafica</td>";
		...
		if ($rs == 7) {
			...
			$pos = $pos+1;
			$sql = ", max_rs, med_rs";
			$cabeza = "<td class='titulo'>RS(W/m2)<br> Max</td><td class='titulo'>RS(W/m2)<br> Med</td><td class='titulo'>Grafica</td>";

			$títulos .= "<td colspan='3' class='titulo'>Radiación solar<br>RS</td>";
			$titRangoAño .=  "<td colspan='3' class='titulo'>Radiación solar<br>RS</td>";
			$titAño .=  "<td colspan='3' class='titulo'>Radiación solar<br>RS</td>";
			$titMes .=  "<td colspan='3' class='titulo'>Radiación solar<br>RS</td>";
			...
			if ($menor!=$mayor) {
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td class='titulo'>Promedio RS(W/m2)<br> Max</td><td class='titulo'>Promedio RS(W/m2)<br> Med</td>
				<td class='titulo'>Grafica</td>";
		...
		if ($pbm == 8) {
			...
			$cabeza = "<td class='titulo'>Max PB<br>(hPa)</td><td class='titulo'>Min PB<br>(hPa)</td><td class='titulo'>Med PB<br>(hPa)</td><td class='titulo'>Grafica</td>";

			$títulos .= "<td colspan='4' class='titulo'>Presión barométrica<br>Pbm-Pbmm</td>";
			$titRangoAño .= "<td colspan='4' class='titulo'>Presión barométrica<br>Pbm-Pbmm</td>";
			$titAño .= "<td colspan='4' class='titulo'>Presión barométrica<br>Pbm-Pbmm</td>";
			$titMes .= "<td colspan='4' class='titulo'>Presión barométrica<br>Pbm-Pbmm</td>";
			...
			if ($menor!=$mayor) {
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td class='titulo'>Promedio Max PB<br>(hPa)</td><td class='titulo'>Promedio Min PB<br>(hPa)</td>
				<td class='titulo'>Promedio Med PB<br>(hPa)</td><td class='titulo'>Grafica</td>";
		...
		if ($confort == 9) {
			...
			$cabeza = "<td class='titulo'>CI</td><td class='titulo'>Sensacion<br>Experimentada</td><td class='titulo'>Grafica</td>";
			$títulos .= "<td colspan='3' class='titulo'>Confort térmico<br>CONFORT-T</td>";
			$titRangoAño .= "<td colspan='2' class='titulo'>Confort térmico<br>CONFORT-T</td>";
			$titAño .= "<td colspan='3' class='titulo'>Confort térmico<br>CONFORT-T</td>";
			$titMes .= "<td colspan='3' class='titulo'>Confort térmico<br>CONFORT-T</td>";
			...
			if ($menor!=$mayor) {
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td class='titulo'>Promedio CI</td><td class='titulo'>Grafica</td>";
		...
		if ($isp == 10) {
			...
			$cabeza = "<td class='titulo'>g(x)</td><td class='titulo'>G(x)</td><td class='titulo'>t</td><td class='titulo'>ISP</td><td class='titulo'>Categoria</td><td class='titulo'>Grafica</td>";
			$titMes .= "<td colspan='6' class='titulo'>Índice estandarizado de precipitación<br>ISP</td>";
		...
		if ($aridez == 11) {
			...
			$cabeza = "<td class='titulo'>Indice de<br>aridez Martonne</td><td class='titulo'>Zona de<br>aridez Martonne</td><td class='titulo'>Grafica</td>";
			$titAño .= "<td colspan='5' class='titulo'>Índice de Aridez<br>I-ARIDEZ</td>";
			$titMes .= "<td colspan='5' class='titulo'>Índice de Aridez<br>I-ARIDEZ</td>";
			$titRangoAño .= "<td colspan='3' class='titulo'>Índice de Aridez<br>I-ARIDEZ</td>";

			$archivoPlano = $separador."Indice de aridez Martonne".$separador."Zona de aridez Martonne";
			$sqlAnual .= ", indice_lang, zona_lang".$sql;
			$cabezaAnual .= "<td class='titulo'>Indice de<br>aridez Lang</td><td class='titulo'>Zona de<br>aridez Lang</td>".$cabeza;
			...
			if ($menor!=$mayor) {
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td class='titulo'>Promedio Indice de<br>aridez Lang</td><td class='titulo'>Promedio Indice de<br>
				aridez Martonne</td><td class='titulo'>Grafica</td>";
	...
	if ($hayDatos) {
		...
		if ($menorOrig!=$mayor) {
			...
			if ($result != null) {
				...
				echo "<tr><td class='titulo'>$nombEstacion</td><td class='titulo'>".$menorOrig." - ".$mayor."</td>";
				$controlGraf=0;
				for ($i=0; $i < $tamRanAnio; $i++) { 
					echo "<td class='titulo'>".$rangAnios[$i]."</td>";
					#echo "<td class='titulo'>".$i."</td>";
					...
					if ($controlGraf == $posGraficaRangoAnios[0] && $temp == 1) {#-$saltosRango && $temp == 1) {
							...
							echo "<a href='graficasLineal.php?variable=$variablee
									&anio=".$menorOrig."&anio2=".$mayor."&origen=anio"
									."&est=".$idEstacion
									."&nes=".$nombEstacion
									...
									."&est=".$idEstacion
									."&nes=".$nombEstacion
									."' target='_blank' >Ver grafica  Dia a Dia"; /*Mes a Mes</a><br><br>
						...
						if ($controlGraf == $posGraficaRangoAnios[1]  && $rangoTemp == 2) { #-$saltosRango  && $rangoTemp == 2) {
							...
							echo "<a href='graficaLineal.php?variable=$variablee
									...
									."&est=".$idEstacion
									."&nes=".$nombEstacion
									."' target='_blank' >Ver grafica Dia a Dia</a>";/*<br><br>
							...
							if ($controlGraf == $posGraficaRangoAnios[2]  && $ppt == 3) { #-$saltosRango-1  && $ppt == 3) {
								...
								echo "<a href='graficaLineal.php?variable=$variablee
										...
										."&est=".$idEstacion
										."&nes=".$nombEstacion
										."' target='_blank' >Ver grafica Dia a Dia</a>";/*Mes a Mes</a><br><br>
										<a href='graficaLinealDia.php?variable=$variablee
											&anio=".$menorOrig."&anio2=".$mayor
											."&est=".$idEstacion
											."&nes=".$nombEstacion
		...
		if ($Anual == 1) {
			...
			if ($result != null) {
				...
				echo "<tr>";
				foreach ($result as $value) {
					echo "<tr><td class='titulo'>$nombEstacion</td>";
					$controlGraf = 0;
					foreach ($value as $field) {
						$controlGraf++;
						echo "<td class='titulo'>$field</td>";
		...
		if ($dia == 3) {
			...
			if ($result != null) {
				...
				foreach ($result as $value) {
					...
					foreach ($value as $field) {
						$controlGraf++;
						/*if ($pptA25 == 4 && ($controlGraf == $posGrafica[3])) {
							echo "<td background-color='#04B404'>$field</td>";
						}else{*/##
							echo "<td class='titulo'>$field</td>";
						}
