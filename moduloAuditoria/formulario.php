...
<center>
    <form action = "resultadosAuditoria.php"  target="_blank" method ="post" >
        ...
        <select name="idVariable" id="idVariable" onchange="obtenerRiesgo();"><option>Seleccione</option></select><br><br>
        <label>Seleccione el Riesgo:</label>
        <select name="idRiesgo" id="idRiesgo"><option>Seleccione</option></select><br><br>
