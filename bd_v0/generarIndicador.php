<?php   
    ...
    if ($_POST) {
		...
		$cabeza = $títulos1."<td>Estación</td>";
		//$arrayCabeza = array(0 => "<br><br><center><table border = 1 ><tr class = 'cabecera'>", 1 => "<td>Estación</td>" );
		$archivoPlano = "Estación";
		...
		if ($dia == 3) {
			...
			$posGrafica = array($incremento, $incremento, $incremento, 
								...
								$incremento, $incremento, $incremento, 
								$incremento, $incremento, $incremento);
			$archivoPlanoDia = $archivoPlano.$separador."Año".$separador."Mes".$separador."Día";
		}
		...
		if ($temp == 1) {
			...
			$pos = $pos+1;
			$sql = ", tmax, tmin, tmed";
			$cabeza = "<td>Temp <br>Máxima (ºC)</td><td>Temp <br>Mínima (ºC)</td><td>Temp<br>Promedio (ºC)</td>
			<td>Gráfica</td>";
			$títulos .= "<td colspan='4'><center>TEMP Temperatura</center></td>";
			$titRangoAño .= "<td colspan='4'><center>TEMP Temperatura</center></td>";
			$titAño .= "<td colspan='4'><center>TEMP Temperatura</center></td>";
			$titMes .= "<td colspan='4'><center>TEMP Temperatura</center></td>";
			$incremento = 3;
			...
			$archivoPlano = $separador."Temp Máxima (ºC)".$separador."Temp Mínima (ºC)".$separador."Temp Promedio (ºC)";
			...
			if ($menor!=$mayor) {
				...
				$cabezaRangoAn.="<td>Promedio Temps<br>Máxima (ºC)</td><td>Promedio Temps<br>Mínima (ºC)</td><td>Promedio Temps<br>Promedio (ºC)</td><td>Gráfica</td>";
				$archivoRangAn.=$separador."Promedio Temps Máxima (ºC)".$separador."Promedio Temps Mínima (ºC)".$separador."Promedio Temps Promedio (ºC)";
		...
		if ($rangoTemp == 2) {
			...
			$pos = $pos+1;
			$sql = ", trango";
			$cabeza = "<td>Rango<br>Temp (ºC)</td><td>Gráfica</td>";
			$títulos .= "<td colspan='2'><center>RANGO-TEMP <br> Amplitud o rango de temperatura</center></td>";
			$titRangoAño .= "<td colspan='2'><center>RANGO-TEMP <br> Amplitud o rango de temperatura</center></td>";
			$titAño .= "<td colspan='2'><center>RANGO-TEMP <br> Amplitud o rango de temperatura</center></td>";
			$titMes .= "<td colspan='2'><center>RANGO-TEMP <br> Amplitud o rango de temperatura</center></td>";
			...
			if ($menor!=$mayor) { 
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td>Promedio Rango<br>Temp (ºC)</td><td>Gráfica</td>";
		...
		if ($ppt == 3) {
			...
			$títulos .= "<td colspan='3'><center>Ppt Precipitación</center></td>";
			$titRangoAño .= "<td colspan='2'><center>Ppt Precipitación</center></td>";
			$titAño .= "<td colspan='3'><center>Ppt Precipitación</center></td>";
			$titMes .= "<td colspan='3'><center>Ppt Precipitación</center></td>";
			...
			if ($menor!=$mayor) {
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td>Promedio Ppt<br>Acumulado (mm)</td><td>Gráfica</td>";
				$archivoRangAn.=$separador."Promedio Ppt Acumulado (mm)";
				$incremento = 1;
			...
			$cabezaDia .= "<td>Intensidad de <br>LLuvia (mm/h)<br>-Primeros 5 minutos-</td><td>Gráfica</td>";
			$archivoPlanoDia .= $separador."Intensidad de LLuvia -Primeros 5 minutos-(mm/h)";

			$sqlMes .= ", dias_sin_lluvia";
			$cabezaMes .= "<td>Días sin<br> LLuvia</td><td>Gráfica</td>";
			$archivoPlanoMes .= $separador."Días sin LLuvia";
		
			$sqlAnual .= ", desc_lluvia";
			$cabezaAnual .= "<td>Descripción</td><td>Gráfica</td>";
			$archivoPlanoAnual .= $separador."Descripción";
		...
		if ($pptA25 == 4) {
			...
			$pos = $pos+1;
			$sqlMes .= ", ac_25";
			$cabezaMes .= "<td>A25<br> Máximo</td><td>Gráfica</td>";
			$titRangoAño .= "<td>A25</td>";
			$archivoPlanoMes .= $separador."A25 Máximo Mes";
			$sqlAnual .= ", ac_25";
			$cabezaAnual .= "<td>A25<br> Máximo</td><td>Gráfica</td>";
			$archivoPlanoAnual .= $separador."A25 Máximo Año";

			$sqlDia .= ", ac_25, nivel_alerta";
			$cabezaDia .= "<td>A25</td><td>Nivel<br>Alerta</td><td>Gráfica</td>";
			$títulos .= "<td colspan='3'><center>Ppt.Ac-A25 <br>Lluvia acumulada</center></td>";
			$titAño .= "<td colspan='2'><center>Ppt.Ac-A25 <br>Lluvia acumulada</center></td>";
			$titMes .= "<td colspan='2'><center>Ppt.Ac-A25 <br>Lluvia acumulada</center></td>";
			
			if ($menor!=$mayor) {
				$cabezaRangoAn.="<td>Gráfica</td>";
				$incremento = 1;
				$posGraficaRangoAnios = array($posGraficaRangoAnios[0], $posGraficaRangoAnios[1], 
							$posGraficaRangoAnios[2], $posGraficaRangoAnios[3]+$incremento, $posGraficaRangoAnios[4]+$incremento, 
							$posGraficaRangoAnios[5]+$incremento, $posGraficaRangoAnios[6]+$incremento, $posGraficaRangoAnios[7]+$incremento, 
							$posGraficaRangoAnios[8]+$incremento, $posGraficaRangoAnios[9]+$incremento, $posGraficaRangoAnios[10]+$incremento);
			}
		...
		if ($dvv == 5) {
			...
			$cabeza = "<td>VV Máximo (m/s)</td><td>Escala<br>Beaufort</td><td>Descripción<br>Beaufort</td>
						<td>VV Media (m/s)</td><td>Escala<br>Beaufort</td><td>Descripción<br>Beaufort</td>
						<td>Gráfica</td>";

			$títulos .= "<td colspan='7'><center>DVV Dirección y velocidad del viento</center></td>";
			$titRangoAño .= "<td colspan='3'><center>DVV Dirección y velocidad del viento</center></td>";
			$titAño .= "<td colspan='7'><center>DVV Dirección y velocidad del viento</center></td>";
			$titMes .= "<td colspan='7'><center>DVV Dirección y velocidad del viento</center></td>";

			$archivoPlano = $separador."VV Máximo (m/s)".$separador."Escala Beaufort".$separador
			...
			if ($menor!=$mayor) {
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td>Promedio VV Máximo (m/s)</td><td>Promedio VV Media (m/s)</td><td>Gráfica</td>";
				$archivoRangAn.=$separador."Promedio VV Máximo (m/s)".$separador."Promedio VV Media (m/s)";
				$incremento = 2;
			...
			$cabezaDia .= "<td>VV Máximo<br>(m/s)</td>
							<td>VV Media<br>(m/s)</td>
							<td>Dirección<br>Diurno</td>
							<td>Frecuencia<br>Dirección<br>Diurno(%)</td>
							<td>Dirección<br>Nocturno</td>
							<td>Frecuencia<br>Dirección<br>Nocturno (%)</td>
							<td>Rosa de<br>los Vientos</td>";
			$archivoPlanoDia .= $separador."VV Máximo (m/s)".$separador."VV Media (m/s)".$separador."Dirección Diurno".$separador."Frecuencia Dirección Diurno (%)".$separador."Dirección Nocturno".$separador."Frecuencia Dirección Nocturno (%)";
		...
		if ($hrmHrmm == 6) {
			...
			$cabeza = "<td>HR<br> Máximo (%)</td><td>HR<br> Mínimo (%)</td><td>HR<br> Media (%)</td><td>Gráfica</td>";
			$títulos .= "<td colspan='4'><center>HRm-HRmm Humedad relativa</center></td>";
			$titRangoAño .= "<td colspan='4'><center>HRm-HRmm Humedad relativa</center></td>";
			$titAño .= "<td colspan='4'><center>HRm-HRmm Humedad relativa</center></td>";
			$titMes .= "<td colspan='4'><center>HRm-HRmm Humedad relativa</center></td>";

			$archivoPlano = $separador."HR Máximo (%)".$separador."HR Mínimo (%)".$separador."HR Media (%)";
			arregloTablasIndicadores($sql, $cabeza, $archivoPlano);
			if ($menor!=$mayor) {
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td>Promedio HR<br> Máximo (%)</td><td>Promedio HR<br> Mínimo (%)</td>
				<td>Promedio HR<br> Media (%)</td><td>Gráfica</td>";
				$archivoRangAn.=$separador."Promedio HR Máximo (%)".$separador."Promedio HR Mínimo (%)".$separador."Promedio HR Media (%)";
				$incremento = 3;
				$posGraficaRangoAnios = array($posGraficaRangoAnios[0], $posGraficaRangoAnios[1], $posGraficaRangoAnios[2], 
		...
		if ($rs == 7) {
			...
			$pos = $pos+1;
			$sql = ", max_rs, med_rs";
			$cabeza = "<td>RS(W/m2)<br> Máximo</td><td>RS(W/m2)<br> Media</td><td>Gráfica</td>";

			$títulos .= "<td colspan='3'><center>RS Radiación solar</center></td>";
			$titRangoAño .=  "<td colspan='3'><center>RS Radiación solar</center></td>";
			$titAño .=  "<td colspan='3'><center>RS Radiación solar</center></td>";
			$titMes .=  "<td colspan='3'><center>RS Radiación solar</center></td>";

			$archivoPlano = $separador."RS(W/m2) Máximo".$separador."RS(W/m2) Media";
			arregloTablasIndicadores($sql, $cabeza, $archivoPlano);
			if ($menor!=$mayor) {
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td>Promedio RS(W/m2)<br> Máximo</td><td>Promedio RS(W/m2)<br> Media</td>
				<td>Gráfica</td>";
				$archivoRangAn.=$separador."Promedio RS(W/m2) Máximo".$separador."Promedio RS(W/m2) Media";
				$incremento = 2;
				$posGraficaRangoAnios = array($posGraficaRangoAnios[0], $posGraficaRangoAnios[1], $posGraficaRangoAnios[2], 
		...
		if ($pbm == 8) {
			...
			$cabeza = "<td>Máxima PB<br>(hPa)</td><td>Mínimo PB<br>(hPa)</td><td>Media PB<br>(hPa)</td><td>Gráfica</td>";

			$títulos .= "<td colspan='4'><center>Pbm-Pbmm Presión barométrica</center></td>";
			$titRangoAño .= "<td colspan='4'><center>Pbm-Pbmm Presión barométrica</center></td>";
			$titAño .= "<td colspan='4'><center>Pbm-Pbmm Presión barométrica</center></td>";
			$titMes .= "<td colspan='4'><center>Pbm-Pbmm Presión barométrica</center></td>";

			$archivoPlano = $separador."Máxima PB (hPa)".$separador."Mínimo PB (hPa)".$separador."Media PB (hPa)";
			arregloTablasIndicadores($sql, $cabeza, $archivoPlano);
			if ($menor!=$mayor) {
				...
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td>Promedio Máxima PB<br>(hPa)</td><td>Promedio Mínimo PB<br>(hPa)</td>
				<td>Promedio Media PB<br>(hPa)</td><td>Gráfica</td>";
				$archivoRangAn.= $separador."Promedio Máxima PB (hPa)".$separador."Promedio Mínimo PB (hPa)".$separador."Promedio Media PB (hPa)";
				$incremento = 3;
				$posGraficaRangoAnios = array($posGraficaRangoAnios[0], $posGraficaRangoAnios[1], $posGraficaRangoAnios[2], 
		...
		if ($confort == 9) {
			...
			$cabeza = "<td>CI</td><td>Sensación<br>Experimentada</td><td>Gráfica</td>";
			$títulos .= "<td colspan='3'><center>CONFORT-T Confort térmico</center></td>";
			$titRangoAño .= "<td colspan='2'><center>CONFORT-T Confort térmico</center></td>";
			$titAño .= "<td colspan='3'><center>CONFORT-T Confort térmico</center></td>";
			$titMes .= "<td colspan='3'><center>CONFORT-T Confort térmico</center></td>";

			$archivoPlano = $separador."CI".$separador."Sensación Experimentada";
			arregloTablasIndicadores($sql, $cabeza, $archivoPlano);
			if ($menor!=$mayor) {
				$sqlRangoAnual.=", sum(ci) AS ".$valRango;
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td>Promedio CI</td><td>Gráfica</td>";
		...
		if ($isp == 10) {
			...
			$cabeza = "<td>g(x)</td><td>G(x)</td><td>t</td><td>ISP</td><td>Categoría</td><td>Gráfica</td>";
			$titMes .= "<td colspan='6'><center>ISP Índice estandarizado</center></td>";
		...
		if ($aridez == 11) {
			...
			$cabeza = "<td>Índice de<br>aridez Martonne</td><td>Zona de<br>aridez Martonne</td><td>Gráfica</td>";
			$titAño .= "<td colspan='5'><center>I-ARIDEZ Índice de Aridez</center></td>";
			$titMes .= "<td colspan='5'><center>I-ARIDEZ Índice de Aridez</center></td>";
			$titRangoAño .= "<td colspan='3'>Índice de<br>aridez Martonne</td>";

			$archivoPlano = $separador."Índice de aridez Martonne".$separador."Zona de aridez Martonne";
			$sqlAnual .= ", indice_lang, zona_lang".$sql;
			$cabezaAnual .= "<td>Índice de<br>aridez Lang</td><td>Zona de<br>aridez Lang</td>".$cabeza;
			$archivoPlanoAnual .= $separador."Índice de aridez Lang".$separador."Zona de aridez Lang".$archivoPlano;
			if ($menor!=$mayor) {
				$sqlRangoAnual.=", sum(indice_lang) AS ".$valRango;
				$valRango.=$nombRang;
				$sqlRangoAnual.=", sum(indice_martonne) AS ".$valRango;
				$valRango.=$nombRang;
				$cabezaRangoAn.="<td>Promedio Índice de<br>aridez Lang</td><td>Promedio Índice de<br>
				aridez Martonne</td><td>Gráfica</td>";
				$archivoRangAn.=$separador."Promedio Índice de aridez Lang".$separador."Promedio Índice de aridez Martonne";
				$incremento = 2;
				$posGraficaRangoAnios = array($posGraficaRangoAnios[0], $posGraficaRangoAnios[1], $posGraficaRangoAnios[2], 
					$posGraficaRangoAnios[3], $posGraficaRangoAnios[4], $posGraficaRangoAnios[5], $posGraficaRangoAnios[6], 
		...
		if ($menorOrig!=$mayor) {
			...
			if ($result != null) {
				...
				for ($i=0; $i < $tamRanAnio; $i++) { 
					...
					$controlGraf++;
					if ($controlGraf == $posGraficaRangoAnios[0] && $temp == 1) {
							$variablee = $temp;
							echo "<td>";
							echo "<a href='graficasLineal.php?variable=$variablee
									...
									<a href='grafRangMes.php?variable=$variablee
									&anio=".$menorOrig."&anio2=".$mayor
									."&est=".$idEstacion
									."&nes=".$nombEstacion
									."' target='_blank' >Ver grafica Mes a Mes</a>";/*<br><br>
									<a href='grafLinRangDia.php?variable=$variablee
									&anio=".$menorOrig."&anio2=".$mayor
									."&est=".$idEstacion
									."&nes=".$nombEstacion
									."' target='_blank'>
						...
						if ($controlGraf == $posGraficaRangoAnios[1]  && $rangoTemp == 2) { 
							$variablee = $rangoTemp;
							echo "<td>";
							echo "<a href='graficaLineal.php?variable=$variablee
									...
									."&nes=".$nombEstacion
									."' target='_blank' >Ver grafica Año a Año</a><br><br>
									<a href='grafLinRangMes.php?variable=$variablee
									&anio=".$menorOrig."&anio2=".$mayor
									."&est=".$idEstacion
									."&nes=".$nombEstacion
									."' target='_blank' >Ver grafica Mes a Mes</a>";/*<br><br>
							...
							if ($controlGraf == $posGraficaRangoAnios[2]  && $ppt == 3) { 
								$variablee = $ppt;
								echo "<td>";
								echo "<a href='graficaLineal.php?variable=$variablee
										&anio=".$menorOrig."&anio2=".$mayor
								...
								if ($controlGraf == $posGraficaRangoAnios[4]   && $dvv == 5) {
									$variablee = $dvv;
									echo "<td>";
									echo "<a href='rosaRangAnual.php?&anio=".$menorOrig
											."&anio2=".$mayor
											."&est=".$idEstacion
											."&nes=".$nombEstacion
											."' target='_blank' >Ver grafica Año a Año</a><br><br>
											<a href='rosRangMes.php?variable=$variablee
											&anio=".$menorOrig."&anio2=".$mayor
											."&est=".$idEstacion
											."&nes=".$nombEstacion
											."' target='_blank' >Ver grafica Mes a Mes</a>";/*<br><br>
											<a href='grafLinRangDia.php?anio=".$menorOrig."&anio2=".$mayor
									...
									if ($controlGraf == $posGraficaRangoAnios[5] && $hrmHrmm == 6) {
										$variablee = $hrmHrmm;
										echo "<td>";
										echo "<a href='graficasLineal.php?variable=$variablee
												&anio=".$menorOrig."&anio2=".$mayor
										...
										if ($controlGraf == $posGraficaRangoAnios[6]  && $rs == 7) { 
											$variablee = $rs;
											echo "<td>";
											echo "<a href='graficLineal.php?variable=$variablee
													...
													."&nes=".$nombEstacion
													."' target='_blank' >Ver grafica Año a Año</a><br><br>
													<a href='graficLinRangMes.php?variable=$variablee
													&anio=".$menorOrig."&anio2=".$mayor
													."&est=".$idEstacion
													."&nes=".$nombEstacion
													."' target='_blank' >Ver grafica Mes a Mes</a>";/*<br><br>
											...
											if ($controlGraf == $posGraficaRangoAnios[7]  && $pbm == 8) {
												$variablee = $pbm;
												echo "<td>";
												echo "<a href='graficasLineal.php?variable=$variablee
														&anio=".$menorOrig."&anio2=".$mayor
												...
												if ($controlGraf == $posGraficaRangoAnios[8]  && $confort == 9) {
													$variablee = $confort;
													echo "<td>";
													echo "<a href='graficaLineal.php?variable=$variablee
															&anio=".$menorOrig."&anio2=".$mayor
													...
													if ($controlGraf == $posGraficaRangoAnios[9]  && $isp == 10) {
														$variablee = $isp;
														echo "<td>";
														echo "<a href='graficaLineal.php?variable=$variablee
																&anio=".$menorOrig."&anio2=".$mayor
														...
														if ($controlGraf == $posGraficaRangoAnios[10] && $aridez == 11) {
															$variablee = $aridez;
															echo "<td>";
															echo "<a href='graficaLineal.php?variable=$variablee
																	&anio=".$menorOrig."&anio2=".$mayor
