...
<div id="listEst">
	<label>   * Las coordenadas (latitud y longitud) de cada estación pueden ser proyectadas correctamente usando: Projected Coordinate System: "Colombia_Bogota_Zone", Projection: "Transverse_Mercator", Geographic Coordinate System: "GCS_Bogota" o configuraciones afines.</label>
	<center>
		<table border="2">
			<tr align="center" >
