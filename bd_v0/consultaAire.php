...
<center>
    <form action = "consultasBodega.php"  target="_blank" method = "post" onsubmit = "return validacion()">
        <table border = 1>
            <tr>
                    ...
                    <select clase="aire" name="idVariable" id="idVariable" onchange="obtenerEstacion();">
                        ...
                        if (getEstacionVar() != null) {
                            foreach (getEstacionVar() as $value) {
                                echo "<option value='".$value["id"]."'>".str_replace("_",",",strtoupper($value["nombre"]))."</option>";
                            }
                        }else{
