<?php   
	...
	if ($_GET) {
		...
		$un = 'una';
		if ($idVariable==1) {$nombreVar='Temperatura '; $unidadMedida='(°C)'; $tipoGraf='scatter';
		}elseif ($idVariable==2) {$nombreVar='Rango Temperatura '; $unidadMedida='(°C)'; $tipoGraf=''; $un = 'un';
		}elseif ($idVariable==3) {$nombreVar='Precipitación '; $unidadMedida='(mm)'; $tipoGraf='column';
		}elseif ($idVariable==4) {$nombreVar='A25 '; $unidadMedida='(mm)'; $tipoGraf=''; $un = 'un';
		}elseif ($idVariable==5) {$nombreVar='Dirección y Velocidad del Viento '; $unidadMedida='(m/s)'; $tipoGraf='';
		}elseif ($idVariable==6) {$nombreVar='Humedad Relativa '; $unidadMedida='(%)'; $tipoGraf='';
		}elseif ($idVariable==7) {$nombreVar='Radiación Solar '; $unidadMedida='(w/m2)'; $tipoGraf='';
		}elseif ($idVariable==8) {$nombreVar='Presión Barométrica '; $unidadMedida='(mmHg)'; $tipoGraf='';
		}elseif ($idVariable==9) {$nombreVar='Confort Térmico'; $unidadMedida=''; $tipoGraf=''; $un = 'un';
		}elseif ($idVariable==10) {$nombreVar='Índice Estandarizado de precipitación'; $unidadMedida=''; $tipoGraf=''; $un = 'un';
		}elseif ($idVariable==11) {$nombreVar='Índice de Aridez'; $unidadMedida=''; $tipoGraf=''; $un = 'un';
		}
